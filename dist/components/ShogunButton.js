...
import { WalletIcon, KeyIcon, NostrIcon, WebAuthnIcon, LogoutIcon, UserIcon, LockIcon, CloseIcon, ImportIcon, ZkProofIcon, ChallengeIcon, ExportIcon } from "./Icons";
...
const PasswordForm = ({ username, setUsername, mode, onToggleMode, onForgotPassword, onSuccess, login, signUp, core }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (mode === "signup") {
                const result = await signUp("password", username, password, passwordConfirm);
    ...
    return (React.createElement("div", { className: "shogun-auth-form" },
        ...
        React.createElement("form", { onSubmit: handleSubmit, className: "shogun-auth-form" },
            React.createElement("div", { className: "shogun-form-group" },
                ...
                React.createElement("input", { type: "text", id: "username", value: username, onChange: (e) => setUsername(e.target.value), disabled: loading, required: true, placeholder: "Enter your username" })),
            React.createElement("div", { className: "shogun-form-group" },
                React.createElement("label", { htmlFor: "password" },
                    React.createElement(LockIcon, null),
                    React.createElement("span", null, "Password")),
                React.createElement("input", { type: "password", id: "password", value: password, onChange: (e) => setPassword(e.target.value), disabled: loading, required: true, placeholder: "Enter your password" })),
            mode === "signup" && (React.createElement(React.Fragment, null,
                React.createElement("div", { className: "shogun-form-group" },
                    ...
                    React.createElement("input", { type: "password", id: "passwordConfirm", value: passwordConfirm, onChange: (e) => setPasswordConfirm(e.target.value), disabled: loading, required: true, placeholder: "Confirm your password" })),
                React.createElement("div", { className: "shogun-form-group" },
                    React.createElement("label", { htmlFor: "hint" },
                        React.createElement(UserIcon, null),
                        React.createElement("span", null, "Password Hint")),
                    React.createElement("input", { type: "text", id: "hint", value: hint, onChange: (e) => setHint(e.target.value), disabled: loading, required: true, placeholder: "Enter your password hint" })),
                React.createElement("div", { className: "shogun-form-group" },
                    React.createElement("label", { htmlFor: "securityQuestion" },
                        React.createElement(UserIcon, null),
                        React.createElement("span", null, "Security Question")),
                    React.createElement("input", { type: "text", id: "securityQuestion", value: securityQuestion, disabled: true })),
                React.createElement("div", { className: "shogun-form-group" },
                    React.createElement("label", { htmlFor: "securityAnswer" },
                        React.createElement(UserIcon, null),
                        React.createElement("span", null, "Security Answer")),
                    React.createElement("input", { type: "text", id: "securityAnswer", value: securityAnswer, onChange: (e) => setSecurityAnswer(e.target.value), disabled: loading, required: true, placeholder: "Enter your security answer" })))),
            ...
            React.createElement("div", { className: "shogun-form-footer" },
                React.createElement("button", { type: "button", className: "shogun-toggle-mode shogun-prominent-toggle", onClick: onToggleMode, disabled: loading }, mode === "login"
                    ? "Don't have an account? Sign up"
                    : "Already have an account? Log in"),
                mode === "login" && (React.createElement("button", { type: "button", className: "shogun-toggle-mode", onClick: onForgotPassword, disabled: loading }, "Forgot password?"))))));
};
                ...
                React.createElement("div", { className: "shogun-modal", onClick: (e) => e.stopPropagation() },
                    ...
                    React.createElement("div", { className: "shogun-modal-content" },
                        ...
                        authView === "password" && (React.createElement(React.Fragment, null,
                            ...
                            React.createElement(PasswordForm, { username: formUsername, setUsername: setFormUsername, mode: formMode, onToggleMode: toggleMode, onForgotPassword: () => setAuthView("recover"), onSuccess: () => setModalIsOpen(false), login: login, signUp: signUp, core: core }))),
